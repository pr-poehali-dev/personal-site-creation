...
const positionsData: Position[] = [
  {
    ...
    period: "Дек 2019 — настоящее время",
    description: "Осуществление руководства и координации деятельности подразделений, планирование специальных операций, контроль выполнения служебно-боевых задач, организация взаимодействия с другими силовыми структурами.",
    skills: ["Оперативное управление", "Тактическая подготовка", "Стратегическое планирование", "Координация подразделений"],
    isCurrent: true,
    rank: 7
  }
];
